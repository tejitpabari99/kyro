/**
 * Exercises tab segment layout (M0-11) — 06 §9: "root ErrorBoundary per tab".
...
export default function ExercisesTabLayout(): React.JSX.Element {
  return (
    <ErrorBoundary boundaryName="tab:exercises" onError={reportBoundaryError}>
      <Slot />
    </ErrorBoundary>
  );
}
