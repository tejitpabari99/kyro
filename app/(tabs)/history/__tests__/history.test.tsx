/**
 * `(tabs)/history` route smoke tests (M2-14 acceptance gate) — proves both
...
describe('/(tabs)/history route', () => {
  ...
  it(
    ...
    async () => {
      await renderRouter('app', { initialUrl: `/history/${mockFixtureWorkout.id}` });
      expect(await screen.findByText('Morning Workout')).toBeTruthy();
  ...
  it(
    ...
    async () => {
      await renderRouter('app', { initialUrl: '/history/does-not-exist' });
